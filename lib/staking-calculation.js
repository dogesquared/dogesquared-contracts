...
function main() {
  ...
  const rateStartBlock = rateStartSec.multipliedBy(secondsPerBlock).plus('0.000000000000000002');
  console.log('rateStartBlock:        ', rateStartBlock.toFixed(decimals));

  const totalBlocks = 2628000;
  const total = rateStartBlock.multipliedBy(totalBlocks);
  console.log('totalBlocks:     ', total.toFixed(decimals));
